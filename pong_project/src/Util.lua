...
function GenerateQuadsBricks(atlas)
    ...
    -- loop for 3 full rows of 6 bricks
    for i = 0, 2 do
        x = 0
        for j = 0, 5 do
...
-- This function is specifically made to piece out the powerups from the spritesheet
-- note we'll only be using two of the icons, one for the powerup, another for the key§
